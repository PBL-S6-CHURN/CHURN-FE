...
function AdminProfile({ adminData, setAdminData, onBack, onLogout }) {
    ...
    <div className="dashboard-wrapper">
      <aside className="sidebar-new">
        ...
        <nav className="nav-menu">
          <div className="nav-link" onClick={onBack} style={{ cursor: 'pointer' }}>
             <span>📈 Dashboard</span>
          </div>
      ...
      <main className="main-content-new">
        <header className="top-bar">
          ...
          <button className="select-tool" onClick={onBack}>← Kembali</button>
        </header>
