...
function Login({ onSwitch, onForget, onLoginSuccess }) {
    ...
    <div className="login-card">
      ...
      <form onSubmit={handleLogin}>
        ...
        <div className="input-group">
          ...
          <a href="#" className="forgot-password" onClick={(e) => { e.preventDefault(); onForget(); }}>
            Forgot Password?
          </a>
        </div>
      ...
      <p className="footer-text">
        Don't have account? <a href="#" onClick={(e) => { e.preventDefault(); onSwitch(); }}>Sign up</a>
      </p>
    </div>
  );
}
